...
function About() {
    return (
        <React.Fragment>
            ...
            <div className="image">
                <img src="/public/about-img.jpg" alt="" />
            </div>
            ...
            <div className="content">
                ...
                <div className="icons-container">
                    <div className="icons">
                        <img src="/public/about-icon-1.png" alt="" />
                        <h3>6+</h3>
                        <span>skill courses</span>
                    </div>
                    <div className="icons">
                        <img src="/public/about-icon-2.png" alt="" />
                        <h3>300+</h3>
                        <span>students</span>
                    </div>
                    <div className="icons">
                        <img src="/public/about-icon-3.png" alt="" />
                        <h3>10+</h3>
                        <span>awards</span>
                    </div>
                </div>
                  ...
                  991: {
                    ...
                    <div className="swiper-wrapper">
                        ...
                        <SwiperSlide className="swiper-slide slide">
                            <div className="image">
                                <img src="/public/teacher-2.png" alt="" />
                                <div className="share">
